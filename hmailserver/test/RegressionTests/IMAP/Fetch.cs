...
namespace RegressionTests.IMAP
{
   ...
   public class Fetch : TestFixtureBase
   {
      ...
      public void TestFetchEnvelopeWithDateContainingQuote()
      {
         ...
         var message = "From: Someone <someone@test.com>" + Environment.NewLine +
                       "To: Someoen <someone@test.com>" + Environment.NewLine +
      ...
      public void TestFetchHeaderFields()
      {
         ...
         Assert.IsTrue(result.Contains("From: Someone <someone@test.com>"));
      ...
      public void PartialFetch_BodyText()
      {
         ...
         Assert.IsTrue(fullSize > 5, string.Format("Body too short ({0}) for a meaningful partial test", fullSize));
      ...
      public void PartialFetch_HeaderFields()
      {
         ...
         Assert.IsTrue(fullSize > 5, string.Format("HEADER.FIELDS response too short ({0}) for a meaningful partial test", fullSize));
      ...
      public void PartialFetch_HeaderFieldsNot()
      {
         ...
         Assert.IsTrue(fullSize > 5, string.Format("HEADER.FIELDS.NOT response too short ({0}) for a meaningful partial test", fullSize));
      ...
      public void FetchRfc822SizeReturnsPositiveInteger()
      {
         ...
         Assert.IsTrue(size > 0, string.Format("RFC822.SIZE should be positive, got {0}", size));
      ...
      public void FetchUidReturnsPositiveInteger()
      {
         ...
         Assert.IsTrue(uid > 0, string.Format("UID should be positive, got {0}", uid));
      ...
      public void TestPartialFetch_HeaderOctetRange()
      {
         ...
         Assert.IsTrue(fullSize > 15, string.Format("Header too short ({0} bytes) for a meaningful partial test", fullSize));
      ...
      public void FetchMimeOfRfc822Part_ReturnsOuterMimeHeaders()
      {
         ...
         Assert.IsFalse(mimeResult.Contains("inner@test.com"), "BODY[2.MIME] must not contain inner message From: " + mimeResult);
         ...
         Assert.IsTrue(headerResult.Contains("inner@test.com"), "BODY[2.HEADER] should contain inner From: " + headerResult);
      ...
      public void FetchHeaderOfRfc822Part_ReturnsInnerHeaders()
      {
         ...
         Assert.IsTrue(headerResult.Contains("inner@test.com"), "BODY[2.HEADER] should contain inner RFC2822 From: " + headerResult);
      ...
      public void PartialFetch_BodyPart_ValidRangeReturnsCorrectBytes()
      {
         ...
         Assert.IsTrue(fullSize > 5, string.Format("Body part too short ({0} bytes) for a meaningful partial test", fullSize));
         var contentStart = fullResult.IndexOf("\r\n", literalEnd) + 2;
         var fullContent = fullResult.Substring(contentStart, fullSize);
