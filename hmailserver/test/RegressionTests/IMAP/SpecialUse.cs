...
namespace RegressionTests.IMAP
{
   ...
   public class SpecialUse : TestFixtureBase
   {
      ...
      public void TestNewAccountDoesNotGetDefaultSpecialUseFoldersByDefault()
      {
         ...
         var account = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "specialuse11@test.com", "test");
      ...
      public void TestNewAccountGetsDefaultSpecialUseFoldersWhenEnabled()
      {
         ...
         var account = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "specialuse12@test.com", "test");
      ...
      public void TestListShowsStoredSpecialUseAttributeForLocalizedFolderName()
      {
         ...
         var account = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "specialuse1@test.com", "test");
      ...
      {
         var account = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "specialuse2@test.com", "test");
      ...
      {
         var account = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "specialuse5@test.com", "test");
      ...
      {
         var account = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "specialuse3@test.com", "test");
      ...
      {
         var account = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "specialuse4@test.com", "test");
      ...
      public void TestCreateWithUnsupportedUseAttributeReturnsUseAttrError()
      {
         ...
         var account = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "specialuse6@test.com", "test");
      ...
      public void TestCreateWithUseAllAttributeReturnsUseAttrError()
      {
         ...
         var account = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "specialuse9@test.com", "test");
      ...
      public void TestCreateWithUseFlaggedAttributeReturnsUseAttrError()
      {
         ...
         var account = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "specialuse10@test.com", "test");
      ...
      public void TestListReturnSpecialUseOptionAnnotatesFolders()
      {
         ...
         var account = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "specialuse7@test.com", "test");
      ...
      public void TestListSelectSpecialUseOptionFiltersFolders()
      {
         ...
         var account = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "specialuse8@test.com", "test");
      ...
      public void TestEmptyAccountRetainsSpecialUseFolders()
      {
         ...
         var account = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "specialuse15@test.com", "test");
      ...
      public void TestEmptyAccountRetainsNestedSpecialUseFolder()
      {
         ...
         var account = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "specialuse17@test.com", "test");
      ...
      public void TestDeletingAccountRemovesSpecialUseFolders()
      {
         ...
         var account = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "specialuse16@test.com", "test");
      ...
      */
      ...
      public void TestDeletingSingleSpecialUseFolderRemovesItFromDatabase()
      {
         ...
         var account = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "specialuse18@test.com", "test");
      ...
      public void TestDeletingSingleSpecialUseFolderByDBIDRemovesItFromDatabase()
      {
         ...
         var account = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "specialuse19@test.com", "test");
      ...
      public void TestImapDeleteRemovesSpecialUseFolderFromDatabase()
      {
         ...
         var account = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "specialuse20@test.com", "test");
      ...
      public void TestDeletingNestedSpecialUseFolderRemovesItFromDatabase()
      {
         ...
         // no longer lists it.
         var account = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "specialuse21@test.com", "test");
      ...
      public void TestImapDeleteRejectsInbox()
      {
         ...
         var account = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "specialuse22@test.com", "test");
      ...
      public void TestDeletingSpecialUseFolderTwiceFailsOnSecondAttempt()
      {
         ...
         // succeeding.
         var account = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "specialuse23@test.com", "test");
