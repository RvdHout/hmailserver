...
namespace RegressionTests.Infrastructure
{
   ...
   public class LogFlushing : TestFixtureBase
   {
      ...
      {
         SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "logflush@example.test", "test");
      ...
      private void SendMessage()
      {
         ...
         smtpClientSimulator.Send("logflush@example.test", "logflush@example.test", "Log flush", "Log flush");
      }
   }
}