   ...
   public class RoundTrip : TestFixtureBase
   {
      ...
      private static string ExtractHeaderValue(string message, string headerName)
      {
         ...
         var match = Regex.Match(normalized,
            string.Format(@"(?m)^{0}:[ \t]*((?:[^\n]|\n[ \t])+)",
            Regex.Escape(headerName)), RegexOptions.IgnoreCase);
      ...
      {
         var account = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "roundtrip@test.com", "test");
      ...
      {
         var account = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "roundtrip3@test.com", "test");
         AddSetHeaderRule(account, "X-Test", "test-value");
      ...
      {
         var account = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "roundtrip4@test.com", "test");
      ...
      {
         var account = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "roundtrip5@test.com", "test");
         AddSetHeaderRule(account, "X-Test", "test-value");
      ...
      {
         var account = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "roundtrip6@test.com", "test");
         AddSetHeaderRule(account, "X-Test", "test-value");
      ...
      {
         var account = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "roundtrip2@test.com", "test");
         AddSetHeaderRule(account, "X-Test", "test-value");
      ...
      {
         var account = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "roundtrip7@test.com", "test");
         AddSetHeaderRule(account, "X-Test", "test-value");
